  ...
  <div class="mt-4">
    ...
    <div class="d-flex gap-4 mt-4 justify-content-center align-items-center">
      ...
      <div class="d-flex flex-column gap-2">
        ...
        <div>
          Total tareas: {{listaTareas.length}}
        </div>
      </div>
    </div>

    <div class="mt-4 flex-column justify-content-center align-items-center d-flex gap-2">
      <div v-for="(tarea, index) in listaTareas" :key="tarea.id" class="d-flex justify-content-center align-items-center gap-2">
      ...
      <div v-for="(tarea, index) in listaTareasCompletadas" :key="tarea.id" class="d-flex justify-content-center align-items-center gap-2">
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      axios.get('http://localhost:8000/api/sessiontest.php')
          .then(response => {
